...
import { Api, Other } from './core/api';
import { Chat, ChatPermissions, InlineQueryResult, InputFile, InputMedia, InputMediaAudio, InputMediaDocument, InputMediaPhoto, InputMediaVideo, LabeledPrice, Message, PassportElementError, Update, User, UserFromGetMe } from './platform';
...
export declare class Context implements RenamedUpdate {
     ...
     */
    editMessageLiveLocation(latitude: number, longitude: number, other?: Other<'editMessageLiveLocation', 'message_id' | 'inline_message_id' | 'latitude' | 'longitude'>, signal?: AbortSignal): Promise<true | (Update.Edited & Message.CommonMessage & {
     ...
     */
    stopMessageLiveLocation(other?: Other<'stopMessageLiveLocation', 'message_id' | 'inline_message_id'>, signal?: AbortSignal): Promise<true | (Update.Edited & Message.CommonMessage & {
        location: import("@grammyjs/types/message").Value;
    })>;
    /**
     ...
     */
    kickAuthor(other?: Other<'kickChatMember', 'user_id'>, signal?: AbortSignal): Promise<true>;
    /**
     * Context-aware alias for `kickChatMember`. Use this method to kick a user from a group, a supergroup or a channel. In the case of supergroups and channels, the user will not be able to return to the chat on their own using invite links, etc., unless unbanned first. The bot must be an administrator in the chat for this to work and must have the appropriate admin rights. Returns True on success.
     *
     * @param user_id Unique identifier of the target user
     ...
     * **Official reference:** https://core.telegram.org/bots/api#kickchatmember
     */
    kickChatMember(user_id: number, other?: Other<'kickChatMember', 'user_id'>, signal?: AbortSignal): Promise<true>;
    /**
     ...
     */
    getChatMembersCount(signal?: AbortSignal): Promise<number>;
    /**
     ...
     */
    editMessageText(text: string, other?: Other<'editMessageText', 'message_id' | 'inline_message_id' | 'text'>, signal?: AbortSignal): Promise<true | (Update.Edited & Message.CommonMessage & {
     ...
     */
    editMessageMedia(media: InputMedia, other?: Other<'editMessageMedia', 'message_id' | 'inline_message_id' | 'media'>, signal?: AbortSignal): Promise<true | (Update.Edited & Message.CaptionableMessage & {
        ...
        document: import("@grammyjs/types/message").Value;
    }) | (Update.Edited & Message.MediaMessage & {
