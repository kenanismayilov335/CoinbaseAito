 ...
 * box.
 */
declare type SupportedFrameworks = 'express' | 'http' | 'https' | 'koa' | 'oak' | 'fastify';
/**
 ...
 * (default: 10_000)
 */
export declare function webhookCallback(bot: Bot, framework?: SupportedFrameworks, onTimeout?: 'throw' | 'return' | ((...args: any[]) => unknown), timeoutMilliseconds?: number): (...args: any[]) => Promise<void>;
export {};
