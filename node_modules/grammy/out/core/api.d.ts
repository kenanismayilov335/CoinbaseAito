...
import { BotCommand, ChatPermissions, InlineQueryResult, InputFile, InputMedia, InputMediaAudio, InputMediaDocument, InputMediaPhoto, InputMediaVideo, LabeledPrice, Opts, PassportElementError } from '../platform';
import { RawApi, ApiClientOptions, TransformerConsumer, WebhookReplyEnvelope, Transformer } from './client';
 ...
 */
export declare type Other<M extends keyof RawApi, X extends keyof Omit<Opts<M>, AlwaysOmittedInOther> = never> = Omit<Opts<M>, AlwaysOmittedInOther | X>;
/**
...
export declare class Api {
     ...
     */
    getUpdates(other?: Other<'getUpdates'>, signal?: AbortSignal): Promise<import("@grammyjs/types/update").Update[]>;
    /**
     ...
     */
    sendMessage(chat_id: number | string, text: string, other?: Other<'sendMessage', 'text'>, signal?: AbortSignal): Promise<import("@grammyjs/types/message").Message.TextMessage>;
    /**
     ...
     */
    forwardMessage(chat_id: number | string, from_chat_id: number | string, message_id: number, other?: Other<'forwardMessage', 'from_chat_id' | 'message_id'>, signal?: AbortSignal): Promise<import("@grammyjs/types/message").Message>;
    /**
     ...
     */
    copyMessage(chat_id: number | string, from_chat_id: number | string, message_id: number, other?: Other<'copyMessage', 'from_chat_id' | 'message_id'>, signal?: AbortSignal): Promise<import("@grammyjs/types/message").MessageId>;
    /**
     ...
     */
    sendPhoto(chat_id: number | string, photo: InputFile | string, other?: Other<'sendPhoto', 'photo'>, signal?: AbortSignal): Promise<import("@grammyjs/types/message").Message.PhotoMessage>;
    /**
     ...
     */
    sendAudio(chat_id: number | string, audio: InputFile | string, other?: Other<'sendAudio', 'audio'>, signal?: AbortSignal): Promise<import("@grammyjs/types/message").Message.AudioMessage>;
    /**
     ...
     */
    sendDocument(chat_id: number | string, document: InputFile | string, other?: Other<'sendDocument', 'document'>, signal?: AbortSignal): Promise<import("@grammyjs/types/message").Message.DocumentMessage>;
    /**
     ...
     */
    sendVideo(chat_id: number | string, video: InputFile | string, other?: Other<'sendVideo', 'video'>, signal?: AbortSignal): Promise<import("@grammyjs/types/message").Message.VideoMessage>;
    /**
     ...
     */
    sendAnimation(chat_id: number | string, animation: InputFile | string, other?: Other<'sendAnimation', 'animation'>, signal?: AbortSignal): Promise<import("@grammyjs/types/message").Message.AnimationMessage>;
    /**
     ...
     */
    sendVoice(chat_id: number | string, voice: InputFile | string, other?: Other<'sendVoice', 'voice'>, signal?: AbortSignal): Promise<import("@grammyjs/types/message").Message.VoiceMessage>;
    /**
     ...
     */
    sendVideoNote(chat_id: number | string, video_note: InputFile | string, other?: Other<'sendVideoNote', 'video_note'>, signal?: AbortSignal): Promise<import("@grammyjs/types/message").Message.VideoNoteMessage>;
    /**
     ...
     */
    sendLocation(chat_id: number | string, latitude: number, longitude: number, other?: Other<'sendLocation', 'latitude' | 'longitude'>, signal?: AbortSignal): Promise<import("@grammyjs/types/message").Message.LocationMessage>;
    /**
     ...
     */
    editMessageLiveLocation(chat_id: number, message_id: number, latitude: number, longitude: number, other?: Other<'editMessageLiveLocation', 'message_id' | 'inline_message_id' | 'latitude' | 'longitude'>, signal?: AbortSignal): Promise<true | (import("@grammyjs/types/update").Update.Edited & import("@grammyjs/types/message").Message.CommonMessage & {
        location: import("@grammyjs/types/message").Value;
    })>;
    /**
     ...
     * **Official reference:** https://core.telegram.org/bots/api#editmessagelivelocation
     */
    editMessageLiveLocationInline(inline_message_id: string, latitude: number, longitude: number, other?: Other<'editMessageLiveLocation', 'message_id' | 'inline_message_id' | 'latitude' | 'longitude'>, signal?: AbortSignal): Promise<true | (import("@grammyjs/types/update").Update.Edited & import("@grammyjs/types/message").Message.CommonMessage & {
        location: import("@grammyjs/types/message").Value;
    })>;
    /**
     ...
     */
    stopMessageLiveLocation(chat_id: number | string, message_id: number, other?: Other<'stopMessageLiveLocation', 'message_id' | 'inline_message_id'>, signal?: AbortSignal): Promise<true | (import("@grammyjs/types/update").Update.Edited & import("@grammyjs/types/message").Message.CommonMessage & {
        location: import("@grammyjs/types/message").Value;
    })>;
    /**
     ...
     * **Official reference:** https://core.telegram.org/bots/api#stopmessagelivelocation
     */
    stopMessageLiveLocationInline(inline_message_id: string, other?: Other<'stopMessageLiveLocation', 'message_id' | 'inline_message_id'>, signal?: AbortSignal): Promise<true | (import("@grammyjs/types/update").Update.Edited & import("@grammyjs/types/message").Message.CommonMessage & {
        location: import("@grammyjs/types/message").Value;
    })>;
    /**
     ...
     */
    sendVenue(chat_id: number | string, latitude: number, longitude: number, title: string, address: string, other?: Other<'sendVenue', 'latitude' | 'longitude' | 'title' | 'address'>, signal?: AbortSignal): Promise<import("@grammyjs/types/message").Message.VenueMessage>;
    /**
     ...
     */
    sendContact(chat_id: number | string, phone_number: string, first_name: string, other?: Other<'sendContact', 'phone_number' | 'first_name'>, signal?: AbortSignal): Promise<import("@grammyjs/types/message").Message.ContactMessage>;
    /**
     ...
     */
    sendPoll(chat_id: number | string, question: string, options: readonly string[], other?: Other<'sendPoll', 'question' | 'options'>, signal?: AbortSignal): Promise<import("@grammyjs/types/message").Message.PollMessage>;
    /**
     ...
     */
    sendDice(chat_id: number | string, emoji: string, other?: Other<'sendDice', 'emoji'>, signal?: AbortSignal): Promise<import("@grammyjs/types/message").Message.DiceMessage>;
    /**
     ...
     */
    getUserProfilePhotos(user_id: number, other?: Other<'getUserProfilePhotos', 'user_id'>, signal?: AbortSignal): Promise<import("@grammyjs/types/manage").UserProfilePhotos>;
    /**
     ...
     */
    kickChatMember(chat_id: number | string, user_id: number, other?: Other<'kickChatMember', 'user_id'>, signal?: AbortSignal): Promise<true>;
    /**
     ...
     */
    unbanChatMember(chat_id: number | string, user_id: number, other?: Other<'unbanChatMember', 'user_id'>, signal?: AbortSignal): Promise<true>;
    /**
     ...
     */
    restrictChatMember(chat_id: number | string, user_id: number, permissions: ChatPermissions, other?: Other<'restrictChatMember', 'user_id' | 'permissions'>, signal?: AbortSignal): Promise<true>;
    /**
     ...
     */
    promoteChatMember(chat_id: number | string, user_id: number, other?: Other<'promoteChatMember', 'user_id'>, signal?: AbortSignal): Promise<true>;
    /**
     ...
     */
    createChatInviteLink(chat_id: number | string, other?: Other<'createChatInviteLink'>, signal?: AbortSignal): Promise<import("@grammyjs/types/manage").ChatInviteLink>;
    /**
     ...
     */
    editChatInviteLink(chat_id: number | string, invite_link: string, other?: Other<'editChatInviteLink', 'invite_link'>, signal?: AbortSignal): Promise<import("@grammyjs/types/manage").ChatInviteLink>;
    /**
     ...
     */
    pinChatMessage(chat_id: number | string, message_id: number, other?: Other<'pinChatMessage', 'message_id'>, signal?: AbortSignal): Promise<true>;
    /**
     ...
     */
    getChatMembersCount(chat_id: number | string, signal?: AbortSignal): Promise<number>;
    /**
     ...
     */
    answerCallbackQuery(callback_query_id: string, other?: Other<'answerCallbackQuery', 'callback_query_id'>, signal?: AbortSignal): Promise<true>;
    /**
     ...
     */
    setMyCommands(commands: readonly BotCommand[], signal?: AbortSignal): Promise<true>;
    /**
     ...
     */
    getMyCommands(signal?: AbortSignal): Promise<BotCommand[]>;
    /**
     ...
     */
    editMessageText(chat_id: number | string, message_id: number, text: string, other?: Other<'editMessageText', 'message_id' | 'text'>, signal?: AbortSignal): Promise<true | (import("@grammyjs/types/update").Update.Edited & import("@grammyjs/types/message").Message.CommonMessage & {
        text: import("@grammyjs/types/message").Value;
    })>;
    /**
     ...
     * **Official reference:** https://core.telegram.org/bots/api#editmessagetext
     */
    editMessageTextInline(inline_message_id: string, text: string, other?: Other<'editMessageText', 'inline_message_id' | 'text'>, signal?: AbortSignal): Promise<true | (import("@grammyjs/types/update").Update.Edited & import("@grammyjs/types/message").Message.CommonMessage & {
        text: import("@grammyjs/types/message").Value;
    })>;
    /**
     ...
     */
    editMessageCaption(chat_id: number | string, message_id: number, other?: Other<'editMessageCaption', 'message_id'>, signal?: AbortSignal): Promise<true | (import("@grammyjs/types/update").Update.Edited & import("@grammyjs/types/message").Message.CaptionableMessage)>;
    /**
     ...
     * **Official reference:** https://core.telegram.org/bots/api#editmessagecaption
     */
    editMessageCaptionInline(inline_message_id: string, other?: Other<'editMessageCaption', 'inline_message_id'>, signal?: AbortSignal): Promise<true | (import("@grammyjs/types/update").Update.Edited & import("@grammyjs/types/message").Message.CaptionableMessage)>;
    /**
     ...
     */
    editMessageMedia(chat_id: number | string, message_id: number, media: InputMedia, other?: Other<'editMessageMedia', 'message_id' | 'media'>, signal?: AbortSignal): Promise<true | (import("@grammyjs/types/update").Update.Edited & import("@grammyjs/types/message").Message.CaptionableMessage & {
        document: import("@grammyjs/types/message").Value;
    } & {
        animation: import("@grammyjs/types/message").Value;
    }) | (import("@grammyjs/types/update").Update.Edited & import("@grammyjs/types/message").Message.CaptionableMessage & {
        audio: import("@grammyjs/types/message").Value;
    }) | (import("@grammyjs/types/update").Update.Edited & import("@grammyjs/types/message").Message.CaptionableMessage & {
        document: import("@grammyjs/types/message").Value;
    }) | (import("@grammyjs/types/update").Update.Edited & import("@grammyjs/types/message").Message.MediaMessage & {
        photo: import("@grammyjs/types/message").Value;
    }) | (import("@grammyjs/types/update").Update.Edited & import("@grammyjs/types/message").Message.MediaMessage & {
        video: import("@grammyjs/types/message").Value;
    })>;
    /**
     ...
     * **Official reference:** https://core.telegram.org/bots/api#editmessagemedia
     */
    editMessageMediaInline(inline_message_id: string, media: InputMedia, other?: Other<'editMessageMedia', 'inline_message_id' | 'media'>, signal?: AbortSignal): Promise<true | (import("@grammyjs/types/update").Update.Edited & import("@grammyjs/types/message").Message.CaptionableMessage & {
        document: import("@grammyjs/types/message").Value;
    } & {
        animation: import("@grammyjs/types/message").Value;
    }) | (import("@grammyjs/types/update").Update.Edited & import("@grammyjs/types/message").Message.CaptionableMessage & {
     ...
     */
    editMessageReplyMarkup(chat_id: number | string, message_id: number, other?: Other<'editMessageReplyMarkup', 'message_id'>, signal?: AbortSignal): Promise<true | (import("@grammyjs/types/update").Update.Edited & import("@grammyjs/types/message").Message)>;
    /**
     ...
     * **Official reference:** https://core.telegram.org/bots/api#editmessagereplymarkup
     */
    editMessageReplyMarkupInline(inline_message_id: string, other?: Other<'editMessageReplyMarkup', 'inline_message_id'>, signal?: AbortSignal): Promise<true | (import("@grammyjs/types/update").Update.Edited & import("@grammyjs/types/message").Message)>;
    /**
     ...
     */
    stopPoll(chat_id: number | string, message_id: number, other?: Other<'stopPoll', 'message_id'>, signal?: AbortSignal): Promise<import("@grammyjs/types/message").Poll>;
    /**
     ...
     */
    sendSticker(chat_id: number | string, sticker: InputFile | string, other?: Other<'sendSticker', 'sticker'>, signal?: AbortSignal): Promise<import("@grammyjs/types/message").Message.StickerMessage>;
    /**
     ...
     */
    createNewStickerSet(user_id: number, name: string, title: string, emojis: string, other?: Other<'createNewStickerSet', 'user_id' | 'name' | 'title' | 'emojis'>, signal?: AbortSignal): Promise<true>;
    /**
     ...
     */
    addStickerToSet(user_id: number, name: string, emojis: string, other?: Other<'addStickerToSet', 'user_id' | 'name' | 'emojis'>, signal?: AbortSignal): Promise<true>;
    /**
     ...
     */
    answerInlineQuery(inline_query_id: string, results: readonly InlineQueryResult[], other?: Other<'answerInlineQuery', 'inline_query_id' | 'results'>, signal?: AbortSignal): Promise<true>;
    /**
     ...
     */
    answerShippingQuery(shipping_query_id: string, ok: boolean, other?: Other<'answerShippingQuery', 'shipping_query_id' | 'ok'>, signal?: AbortSignal): Promise<true>;
    /**
     ...
     */
    answerPreCheckoutQuery(pre_checkout_query_id: string, ok: boolean, other?: Other<'answerPreCheckoutQuery', 'pre_checkout_query_id' | 'ok'>, signal?: AbortSignal): Promise<true>;
    /**
     ...
     */
    sendGame(chat_id: number, game_short_name: string, other?: Other<'sendGame', 'game_short_name'>, signal?: AbortSignal): Promise<import("@grammyjs/types/message").Message.GameMessage>;
    /**
     ...
     */
    setGameScore(chat_id: number, message_id: number, user_id: number, score: number, other?: Other<'setGameScore', 'message_id' | 'user_id' | 'score'>, signal?: AbortSignal): Promise<true | (import("@grammyjs/types/update").Update.Edited & import("@grammyjs/types/message").Message.CommonMessage & {
        game: import("@grammyjs/types/message").Value;
    })>;
    /**
     ...
     * **Official reference:** https://core.telegram.org/bots/api#setgamescore
     */
    setGameScoreInline(inline_message_id: string, user_id: number, score: number, other?: Other<'setGameScore', 'inline_message_id' | 'user_id' | 'score'>, signal?: AbortSignal): Promise<true | (import("@grammyjs/types/update").Update.Edited & import("@grammyjs/types/message").Message.CommonMessage & {
        game: import("@grammyjs/types/message").Value;
    })>;
    /**
