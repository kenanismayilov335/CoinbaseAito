...
import { ApiResponse, Opts, Telegram } from '../platform';
/**
 ...
 */
export declare type ApiCallFn = <M extends keyof RawApi>(method: M, payload: Opts<M>, signal?: AbortSignal) => Promise<ApiResponse<ReturnType<Telegram[M]>>>;
/**
 ...
 */
export declare type Transformer = <M extends keyof RawApi>(prev: ApiCallFn, method: M, payload: Opts<M>, signal?: AbortSignal) => Promise<ApiResponse<ReturnType<Telegram[M]>>>;
export declare type TransformerConsumer = TransformableApi['use'];
/**
...
export interface ApiClientOptions {
     ...
     */
    baseFetchConfig?: Omit<Exclude<Parameters<typeof fetch>[1], undefined>, 'method' | 'headers' | 'body'>;
}
/**
 ...
 */
export declare function createRawApi(token: string, options?: ApiClientOptions, webhookReplyEnvelope?: WebhookReplyEnvelope): TransformableApi;
