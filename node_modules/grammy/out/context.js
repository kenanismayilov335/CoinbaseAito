...
class Context {
    ...
    get chat() {
        var _a;
        // Keep in sync with types in `filter.ts`.
        return (_a = this.msg) === null || _a === void 0 ? void 0 : _a.chat;
    }
    /**
    ...
    get from() {
        ...
        // Keep in sync with types in `filter.ts`.
        return (_f = ((_e = (_d = (_c = (_b = (_a = this.callbackQuery) !== null && _a !== void 0 ? _a : this.inlineQuery) !== null && _b !== void 0 ? _b : this.shippingQuery) !== null && _c !== void 0 ? _c : this.preCheckoutQuery) !== null && _d !== void 0 ? _d : this.chosenInlineResult) !== null && _e !== void 0 ? _e : this.msg)) === null || _f === void 0 ? void 0 : _f.from;
    }
    /**
    ...
    editMessageLiveLocation(latitude, longitude, other, signal) {
        var _a, _b;
        const inlineId = (_b = ((_a = this.callbackQuery) !== null && _a !== void 0 ? _a : this.chosenInlineResult)) === null || _b === void 0 ? void 0 : _b.inline_message_id;
