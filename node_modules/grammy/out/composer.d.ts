...
import { Filter, FilterQuery } from './filter';
...
export declare class Composer<C extends Context> implements MiddlewareObj<C> {
     ...
     * @param middleware The middleware to register
     */
    hears(trigger: MaybeArray<string | RegExp>, ...middleware: Array<Middleware<Filter<C, ':text' | ':caption'>>>): Composer<Filter<C, ':text' | ':caption'>>;
    /**
     ...
     * @param middleware The middleware to register
     */
    command(command: MaybeArray<string>, ...middleware: Array<Middleware<Filter<C, ':entities:bot_command'>>>): Composer<Filter<C, ':entities:bot_command'>>;
    /**
    ...
    filter(predicate: (ctx: C) => boolean, ...middleware: Array<Middleware<C>>): Composer<C>;
    /**
     * > This is an advanced method of grammY.
     *
     * Registers middleware behind a custom filter function that operates on the
     ...
     * @param middleware The middleware to register
     */
    drop(predicate: (ctx: C) => boolean, ...middleware: Array<Middleware<C>>): Composer<C>;
    /**
     * > This is an advanced method of grammY.
     *
     ...
     */
    branch(predicate: (ctx: C) => boolean, trueMiddleware: MaybeArray<Middleware<C>>, falseMiddleware: MaybeArray<Middleware<C>>): Composer<C>;
}
export {};
